package com.tyc.xiaohongshu.user.relation.biz.service.impl;
...
import com.tyc.xiaohongshu.user.relation.biz.constant.MQConstants;
import com.tyc.xiaohongshu.user.relation.biz.domain.dataobject.FansDO;
import com.tyc.xiaohongshu.user.relation.biz.domain.dataobject.FollowingDO;
import com.tyc.xiaohongshu.user.relation.biz.domain.mapper.FansDOMapper;
import com.tyc.xiaohongshu.user.relation.biz.domain.mapper.FollowingDOMapper;
import com.tyc.xiaohongshu.user.relation.biz.model.dto.FollowUserMqDTO;
import com.tyc.xiaohongshu.user.relation.biz.model.dto.UnfollowUserMqDTO;
...
import com.tyc.xiaohongshu.user.relation.biz.constant.RedisKeyConstants;
import com.tyc.xiaohongshu.user.relation.biz.enums.LuaResultEnum;
import com.tyc.xiaohongshu.user.relation.biz.enums.ResponseCodeEnum;
import com.tyc.xiaohongshu.user.relation.biz.rpc.UserRpcService;
import com.tyc.xiaohongshu.user.relation.biz.service.RelationService;
...
public class RelationServiceImpl implements RelationService {
     ...
     */
    @Override
    public Response<?> follow(FollowUserReqVO followUserReqVO) throws BizException {
        // 关注的用户 ID
     ...
     */
    @Override
    public Response<?> unfollow(UnfollowUserReqVO unfollowUserReqVO) throws BizException {
        // 想要取关了用户 ID
