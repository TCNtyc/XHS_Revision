package com.tyc.xiaohongshu.framework.common.util;
...
public class JsonUtils {
    ...
    // Method to parse JSON into Map<Long, Integer>
    public static <K, V> Map<K, V> parseMap(String json, Class<K> keyClass, Class<V> valueClass) throws Exception {
        try {
            // Use ObjectMapper to parse the JSON string into a Map
            return objectMapper.readValue(json, new TypeReference<Map<K, V>>() {
            });
        } catch (Exception e) {
            throw new Exception("Error parsing JSON string to Map", e);
        }
    }
    /**
