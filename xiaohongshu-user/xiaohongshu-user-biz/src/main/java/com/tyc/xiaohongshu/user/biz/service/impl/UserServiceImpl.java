package com.tyc.xiaohongshu.user.biz.service.impl;
...
import com.tyc.xiaohongshu.user.biz.constant.RedisKeyConstants;
import com.tyc.xiaohongshu.user.biz.constant.RoleConstants;
import com.tyc.xiaohongshu.framework.common.eumns.DeletedEnum;
import com.tyc.xiaohongshu.framework.common.eumns.SexEnum;
import com.tyc.xiaohongshu.framework.common.eumns.StatusEnum;
...
import com.tyc.xiaohongshu.framework.common.util.ParamUtils;
import com.tyc.xiaohongshu.user.biz.domain.mapper.RoleDOMapper;
import com.tyc.xiaohongshu.user.biz.domain.mapper.UserDOMapper;
import com.tyc.xiaohongshu.user.biz.domain.mapper.UserRoleDOMapper;
import com.tyc.xiaohongshu.user.biz.enums.ResponseCodeEnum;
import com.tyc.xiaohongshu.user.biz.model.vo.UpdateUserInfoReqVO;
import com.tyc.xiaohongshu.user.biz.rpc.OssRpcService;
...
import com.tyc.xiaohongshu.user.biz.rpc.DistributedIdGeneratorRpcService;
...
import com.tyc.xiaohongshu.user.oss.api.FileFeignApi;
...
public class UserServiceImpl implements UserService {
     ...
     */
    @Override
    public Response<?> updateUserInfo(UpdateUserInfoReqVO updateUserInfoReqVO) throws BizException {
        UserDO userDO = new UserDO();
        // 设置当前需要更新的用户 ID
        userDO.setId(LoginUserContextHolder.getUserId());
        log.info("## updateUserInfoReqVO_id, 用户 ID: {}", LoginUserContextHolder.getUserId());
    ...
    @Override
    public Response<FindUserByPhoneRspDTO> findByPhone(FindUserByPhoneReqDTO findUserByPhoneReqDTO) throws BizException {
     ...
     */
    @Override
    public Response<FindUserByIdRspDTO> findById(FindUserByIdReqDTO findUserByIdReqDTO) throws BizException {
