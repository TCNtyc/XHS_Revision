package com.tyc.xiaohongshu.user.oss.api;

import com.tyc.xiaohongshu.framework.common.response.Response;
import com.tyc.xiaohongshu.user.oss.config.FeignFormConfig;
import com.tyc.xiaohongshu.user.oss.constant.ApiConstants;
