package com.tyc.xiaohongshu.note.biz.service.impl;
...
import com.tyc.xiaohongshu.framework.common.util.DateUtils;
import com.tyc.xiaohongshu.framework.common.util.JsonUtils;
import com.tyc.xiaohongshu.framework.context.holder.LoginUserContextHolder;
import com.tyc.xiaohongshu.note.biz.constant.MQConstants;
import com.tyc.xiaohongshu.note.biz.constant.RedisKeyConstants;
import com.tyc.xiaohongshu.note.biz.domain.dataobject.NoteCollectionDO;
import com.tyc.xiaohongshu.note.biz.domain.dataobject.NoteDO;
import com.tyc.xiaohongshu.note.biz.domain.dataobject.NoteLikeDO;
import com.tyc.xiaohongshu.note.biz.domain.mapper.NoteCollectionDOMapper;
import com.tyc.xiaohongshu.note.biz.domain.mapper.NoteDOMapper;
import com.tyc.xiaohongshu.note.biz.domain.mapper.NoteLikeDOMapper;
import com.tyc.xiaohongshu.note.biz.domain.mapper.TopicDOMapper;
import com.tyc.xiaohongshu.note.biz.enums.*;
import com.tyc.xiaohongshu.note.biz.model.dto.CollectUnCollectNoteMqDTO;
import com.tyc.xiaohongshu.note.biz.model.dto.LikeUnlikeNoteMqDTO;
import com.tyc.xiaohongshu.note.biz.model.dto.NoteOperateMqDTO;
import com.tyc.xiaohongshu.note.biz.model.vo.*;
import com.tyc.xiaohongshu.note.biz.rpc.DistributedIdGeneratorRpcService;
import com.tyc.xiaohongshu.note.biz.rpc.FindNoteDetailRspVO;
import com.tyc.xiaohongshu.note.biz.rpc.KeyValueRpcService;
import com.tyc.xiaohongshu.note.biz.rpc.UserRpcService;
...
public class NoteServiceImpl implements NoteService {
     ...
     */
    @Override
    public Response<?> publishNote(PublishNoteReqVO publishNoteReqVO) throws BizException {
        // 笔记类型
     ...
     */
    private void checkNoteVisibleFromVO(Long userId, FindNoteDetailRspVO findNoteDetailRspVO) throws BizException {
    ...
    public Response<?> updateNote(UpdateNoteReqVO updateNoteReqVO) throws BizException {
        // 笔记 ID
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public Response<?> deleteNote(DeleteNoteReqVO deleteNoteReqVO) throws BizException {
        // 笔记 ID
     ...
     */
    @Override
    public Response<?> visibleOnlyMe(UpdateNoteVisibleOnlyMeReqVO updateNoteVisibleOnlyMeReqVO) throws BizException {
        // 笔记 ID
     ...
     */
    @Override
    public Response<?> topNote(TopNoteReqVO topNoteReqVO) throws BizException {
        // 笔记 ID
    ...
    @SneakyThrows
    @Override
    public Response<FindNoteDetailRspVO> findNoteDetail(FindNoteDetailReqVO findNoteDetailReqVO) throws BizException {
        // 查询的笔记 ID
     ...
     */
    @Override
    public Response<?> likeNote(LikeNoteReqVO likeNoteReqVO) throws BizException {
        // 笔记ID
     ...
     * @param noteId
     */
    private Long checkNoteIsExistAndGetCreatorId(Long noteId) throws BizException {
        // 先从本地缓存校验
        String findNoteDetailRspVOStrLocalCache = LOCAL_CACHE.getIfPresent(noteId);
        // 解析 Json 字符串为 VO 对象
        FindNoteDetailRspVO findNoteDetailRspVO = JsonUtils.parseObject(findNoteDetailRspVOStrLocalCache, FindNoteDetailRspVO.class);
    ...
    @Override
    public Response<?> unlikeNote(UnlikeNoteReqVO unlikeNoteReqVO) throws BizException {
        // 笔记ID
     ...
     */
    @Override
    public Response<?> collectNote(CollectNoteReqVO collectNoteReqVO) throws BizException {
        // 笔记ID
     ...
     */
    @Override
    public Response<?> unCollectNote(UnCollectNoteReqVO unCollectNoteReqVO) throws BizException {
        // 笔记ID
        ...
        // 4. 发送 MQ, 数据更新落库
        // 构建消息体 DTO
        LikeUnlikeNoteMqDTO unCollectNoteMqDTO = LikeUnlikeNoteMqDTO.builder()
                .userId(userId)
                .noteId(noteId)
                .type(LikeUnlikeNoteTypeEnum.UNLIKE.getCode()) // 取消点赞笔记
                .createTime(LocalDateTime.now())
